  ...
  return (
    ...
    <section className=" flex flex-col items-center  px-10 py-20 space-y-10 bg-[#22272a] text-white">
      ...
      <div className='flex flex-col items-center space-y-3'>
        ...
        <p className='text-center'>Join our network of esteemed investors and become a member for free. At icma, we understand the value of investment opportunities that meet investor criteria. We take on projects with entrepreneurs that typically have a track record and where the project has shown traction and is in a scaling phase. Exceptionally we sometimes show pre-revenue opportunities in case we find the credentials strong enough for investors. </p>
        <p className='text-center'>If you're an investor seeking deals that have met our criteria of investment, which include founders team experience, track record, traction and potential for growth or scalability, then join. Established in 2010, we set on our mission to revolutionize the way of sustainable funding. By welcoming also green crypto holders, we step into a new era by embracing the power of cryptocurrency. </p>
      </div>
      <div className='flex flex-col items-center space-y-3'>
